...
const StarReview = ({rate}) => {
    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', borderRadius: 15}}>
            {starComponent}
            <Text style={{ marginLeft: SIZES.base, color: COLORS.gray, ...FONTS.body4}}>
                {rate}
            </Text>
        </View>
    )
...
const IconLabel = ({icon, label}) => {
    return (
        <View style={{alignItems: "center"}}>
            ...
            />
            <Text style={{ marginTop: 12, color: COLORS.gray, ...FONTS.h4}}>{label}</Text>
        </View>
    )
}
    ...
    return (
        <View style={styles.container}>
            <View style={{ flex: 2 }}>
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        <View style={[{borderRadius: 15}, styles.shadow]}>
                            <Image 
                        ...
                        <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around'}}>
                            <Text style={{ ...FONTS.h4}}>Ski Villa</Text>
                    ...
                    <View style={{ marginTop: SIZES.radius}}>
                        <Text style={{ color: COLORS.gray, ...FONTS.body4}}>
                            Ski Villa Offers simple rooms with mountains in front of the ski lift to the Ski Resort
                        </Text>
                    </View>
            ...
            <View style={{ flex: 0.5, paddingHorizontal: SIZES.padding }}>
                <LinearGradient
                    style={{height: 65, width: "100%", borderRadius: 15}}
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <TouchableOpacity
                            style={{ width: 130, height: '60%', marginHorizontal: SIZES.radius }}
